...
Invoice.prototype = {
     ...
     */
    newRow: function () {
        jQuery(".item-row:last").after('<tr class="item-row"><td class="item-name"><div class="delete-btn"><input type="text" class="form-control item" placeholder="Ride" type="text"><a class=' + $.opt.delete.substring(1) + ' href="javascript:;" title="Remove row">X</a></div></td><td><input class="form-control qty" placeholder="Distance" type="text"> </td><td><input class="form-control price" placeholder="Fare(Per KM)" type="text"></td><td><span class="total">0.00</span></td></tr>');
