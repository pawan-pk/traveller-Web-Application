...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
        <img src="images/Cabs1details.jpg" alt=""/>
    </div>
    <div class="item">
        <img src="images/img2.jpg" alt=""/>
    </div>
    <div class="item">
        <img src="images/img3 copy.jpg" alt=""/>
    </div>
  </div>
    ...
    <span class="sr-only">Next</span>
            ...
            <div class="row">
                ...
                <div class="col-sm-3 hvr-bounce-in img-thumbnail img-rounded" style="background: grey;min-height: 300px; margin: 40px;">
                    <img src="images/11 Seater Maharaja Tempo Traveller.jpg" class="img img-responsive img-center" style="height:200px;width:100%;" alt=""/>
                ...
                <div class="col-sm-3 hvr-bounce-in img-thumbnail img-rounded" style="background: grey;min-height: 300px; margin: 40px;">
                    <img src="images/12 SEATER MAHARAJA TEMPO TRAVELLER.jpg" class="img img-responsive img-center" style="height:200px;width:100%;" alt=""/>
                ...
                <div class="col-sm-3 hvr-bounce-in img-thumbnail img-rounded" style="background: grey;min-height: 300px; margin: 40px;">
                    <img src="images/9 Seater Maharaja Tempo Traveller.jpg" class="img img-responsive img-center" style="height:200px;width:100%;" alt=""/>
                ...
                <div class="col-sm-3 hvr-bounce-in img-thumbnail img-rounded" style="background: grey;min-height: 300px; margin: 40px;">
                    <img src="images/cab1.jpg" class="img img-responsive img-center" style="height:200px;width:100%;" alt=""/>
                ...
                <div class="col-sm-3 hvr-bounce-in img-thumbnail img-rounded" style="background: grey;min-height: 300px; margin: 40px;">
                    <img src="images/cab2.jpg" class="img img-responsive img-center" style="height:200px;width:100%;" alt=""/>
                    <h3 class="text-responsive text-center text-success">Details : AC Cabs</h3>
                ...
                <div class="col-sm-3 hvr-bounce-in img-thumbnail img-rounded" style="background: grey;min-height: 300px; margin: 40px;">
                    <img src="images/cab3.png" class="img img-responsive img-center" style="height:200px;width:100%;" alt=""/>
                    <h3 class="text-responsive text-center text-success">Details : AC Cabs</h3>
                ...
                <div class="col-sm-3 hvr-bounce-in img-thumbnail img-rounded" style="background: grey;min-height: 300px; margin: 40px;">
                    <img src="images/ola.png" class="img img-responsive img-center" style="height:200px;width:100%;" alt=""/>
                ...
                <div class="col-sm-3 hvr-bounce-in img-thumbnail img-rounded" style="background: grey;min-height: 300px; margin: 40px;">
                    <img src="images/uber.jpg" class="img img-responsive img-center" style="height:200px;width:100%;" alt=""/>
                ...
                <div class="col-sm-3 hvr-bounce-in img-thumbnail img-rounded" style="background: grey;min-height: 300px; margin: 40px;">
                    <img src="images/ola2.jpg" class="img img-responsive img-center" style="height:200px;width:100%;" alt=""/>
                    <h3 class="text-responsive text-center text-success">Details : OLA Cabs Services</h3>
                    <h4 class="text-center">Offer : 20% of minimum 60KM travel.</h4>
                    <div class="col-sm-6 text-center">
                        <button class="btn btn-warning" name="cart_id">Add to Cart</button>
